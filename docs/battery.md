...
| Wi-Fi scan                 |  100 mA |              5 s |         0.139 mAh |
| GNSS fix                   |   52 mA |             30 s |         0.433 mAh |
| GNSS timeout               |   52 mA |            120 s |          1.73 mAh |
| Cellular data transmission |  110 mA |             10 s |         0.306 mAh |
| Full cycle — Wi-Fi home    |       — |      ~7 s active | ~0.17 mAh + sleep |
| Full cycle — Wi-Fi + data  |       — |     ~17 s active | ~0.47 mAh + sleep |
| Full cycle — GNSS + data   |       — |     ~47 s active | ~1.91 mAh + sleep |

Worst case with 3450 mAh 18650 battery and 24 GNSS + data cycles a day: 53 days.
